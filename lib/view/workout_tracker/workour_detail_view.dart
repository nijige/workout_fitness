...
import 'package:workout_app/common_widget/exercises_set_section.dart';
...
import 'package:workout_app/view/workout_tracker/exercises_stpe_details.dart';
import 'package:workout_app/view/workout_tracker/workout_schedule_view.dart';
...
class _WorkoutDetailViewState extends State<WorkoutDetailView> {
  ...
  void saveWorkoutDetails() async {
    Map<String, dynamic> workoutDetails = {
      'date': '27/05', // Coloque a data real aqui
      'time': '09:00 AM', // Coloque o horário real aqui
      'workout_title': widget.dObj["title"].toString(),
      'workout_exercises': jsonEncode(widget.dObj["exercises"]),
      'difficulty': 'Beginner', // Coloque a dificuldade real aqui
      'repetitions': '', // Coloque as repetições reais aqui
      'weights': '', // Coloque os pesos reais aqui
      // Adicione outras propriedades que você deseja salvar
    };

    int result = await dbHelper.insertSchedule(workoutDetails);

    if (result != -1) {
      // Os detalhes do treino foram salvos com sucesso.
      Navigator.pop(context);
    } else {
      // Ocorreu um erro ao salvar os detalhes do treino.
      print('Erro ao salvar os detalhes do treino');
    }
  }
}
